...
l3_test(&HMRMatch) {
	...
	l3_expect(HMRMatch([[HMRCombinator literal:@"x"] concat:[HMRCombinator literal:@"y"]], @[ [[[HMRAny() concat:HMRBind()] quote] then:REDIdentityMapBlock] ])).to.equal([HMRCombinator literal:@"y"]);
}
